...
const PreApprovedUsers = ({ title, preApproved, nonApproved, updateApproved, closeModal }: Props) => {
    ...
    useEffect(() => {
        ...
        setApproved([...preApproved.map(u => u.email)])
        setNormal([...nonApproved.map(u => u.email)])
